...
<ul class="chat">
                                    ...
                                    <?php 
                                      ...
                                      $consultapreguntas="SELECT id_sesion, c.id_registrado, pregunta, fecha, nombreconstancia FROM chat as c INNER JOIN registrados as r ON c.id_registrado = r.id_registrado WHERE id_sesion = ".$_GET['ref']." ORDER BY fecha DESC";
