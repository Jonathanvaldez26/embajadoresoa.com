...
<script>
  ...
  <div id="content-wrap">
    ...
    <main class="row" style="max-width: 100%;">
      <h1 style="font-size: 30px !important ;color: #fff;"><?php echo $sesion['tema']; ?></h1>
      <div class="col-md-8 <?php if ($sesion['id_sesion']==1){ echo 'col-md-offset-2'; } ?>">
        <div class="embed-responsive embed-responsive-16by9">
          <?php echo $sesion['url_streaming']; ?>
        </div>
        <div class="info">
          <p></p>
        </div>
      </div>
      <?php if ($sesion['id_sesion']!=1) { ?>
      <div class="col-md-4" style="margin: 15px 0;">
        ...
        <div class="panel panel-info" style="border-color: #010834">
          <div class="panel-heading" style="background: #010834; border-color: #010834; color: #fff;">
          ...
          <div class="panel-body" id="mc-signup">
            <form id="form-pregunta" class="group" autocomplete="nope" action="" method="POST" onsubmit="return false;" accept-charset="utf-8">
              <input type="text" name="pregunta" id="pregunta" style="background: #010834; color: #fff; width: 100%;">
              <input type="hidden" name="registrado" id="registrado" value="<?php echo $_SESSION['registrado']['id_registrado']; ?>">
              <button class="login100-form-btn" style="background:#010834; color: #fff;" id="btn-enviar">Enviar</button>
            </form>
          </div> 
        </div>
