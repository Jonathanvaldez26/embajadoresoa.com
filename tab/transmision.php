  ...
  <div id="content-wrap">
    ...
    <main class="row" style="max-width: 100%;">
      ...
      <div class="col-md-4" style="margin: 15px 0;">
        ...
        <div class="panel panel-info" style="border-color: #ef6a37">
          <div class="panel-heading" style="background: #ef6a37; border-color: #ef6a37; color: #fff;">
          ...
          <div class="panel-body" id="mc-signup">
            <form id="form-pregunta" class="group" autocomplete="nope" action="" method="POST" onsubmit="return false;" accept-charset="utf-8">
              <input type="text" name="pregunta" id="pregunta" style="background: #f7865b; color: #fff; width: 100%;">
              <input type="hidden" name="registrado" id="registrado" value="<?php echo $_SESSION['registrado']['id_registrado']; ?>">
              <button class="login100-form-btn" style="background:#ef6a37; color: #fff;" id="btn-enviar">Enviar</button>
            </form>
          </div> 
        </div>
