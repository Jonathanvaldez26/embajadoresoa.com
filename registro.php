...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-179334855-18"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-179334855-18');
</script>
...
<body>
  <div id="particles-js"></div>
   ...
   <!-- content-wrap -->
   <div id="content-wrap">
    <img src="img/marcas.png" id="imagen_marcas" class="img-responsive" style="margin: 0 auto;">
      <!-- main  -->
      ...
      <main class="row">
            ...
            <div class="logo col-xs-12">
              <img src="img/logo_embajadores_.png" style="margin: 30px auto;" class="img-responsive">
            ...
            <div id="main-content" class="twelve columns fondo" style="color: #ffffff !important;">
               ...
               <p><?php echo utf8_encode(ucfirst(strftime("%A, %d de %B del %Y",strtotime($sesion['fecha'])))); ?>. <br>Hora <?php echo $sesion['hora']; ?> CDMX (GMT - 5)
               </p>
              <!-- <p>QUEDAN <?=$restantes?> LUGARES</p> -->
        
        
        
               <p><strong>Nota: Podrá ingresar al taller  15 minutos antes de dar inicio.</strong></p>
               ...
               <div id="mc-signup">
                  ...
                  <h3 style="text-transform: uppercase;">Registro cerrado</h3>
                
<!-- 
                <h3 style="text-transform: uppercase;">Ingresa tu correo</h3>

                  <form id="form-ingresar" class="group" autocomplete="nope" action="" method="POST" onsubmit="return false;" accept-charset="utf-8">
                          
                     <input type="email" value="" name="email" class="email" id="email" required autofocus placeholder="Escriba su email aquí">                       
 ...
 -->
            ...
            <div class="modal-toggles fondo" style=" padding-bottom: 30px;">
              <a href="https://wa.me/525578882173?text=ASOFARMA EMBAJADORES OA" class="whatsapp" target="_blank"><p>Soporte <br>Técnico</p> <i class="fa fa-whatsapp whatsapp-icon"></i></a>
               <ul>
	...
	<section id="mod-about" >
      ...
      <div class="row" style="margin:10px 0;background: none;">
        <div class="col-md-12 columns mob-whole">
          <img src="img/Agenda-Embajadores.png" style="width: 100%;" class="img-responsive">
        </div>
      </div>
   ...
   <section id="mod-registro" >
      ...
      <form id="form-registro" class="group" autocomplete="nope" action="" method="POST" onsubmit="return false;" accept-charset="utf-8">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
             <label class="col-form-label">Cédula Profesional</label>
         ...
         <div class="form-group">
          <div class="col-md-12" style="text-align: center;">
            <label class="col-form-label">Te interesa el taller de viscosuplementación?</label>
            <div class="radio">
              <label>
...
<script type="text/javascript">
   ...
   $(function() {
      $("#btn-registro").click(function(){
         if($("#prefijo").val()!="" && $("#nombre").val()!="" && $("#apellidop").val()!="" && $("#apellidom").val()!="" && $("#email-registro").val()!="" && $("#telefono").val()!="" && $("#pais").val()!="" && $("#estado").val()!="" && $("#especialidad").val()!="" && $("#cedula").val()!="" && $("input:radio[name=recibir_correo]").is(':checked')){
...
<script type="text/javascript">
var finalDate = '<?php echo $fecha_sesion; ?>';
