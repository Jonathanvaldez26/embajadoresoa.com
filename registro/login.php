...
session_start();
  ...
  if (isset($_POST['usuario']) && isset($_POST['contrasena'])) {
    $query="SELECT * FROM usuarios WHERE usuario='".$_POST['usuario']."' and contrasena='".$_POST['contrasena']."' limit 1";
    $resultados=$bd->ExecuteE($query);
    foreach ($resultados as &$resultado) {
      $_SESSION['admin']['id']=$resultado['id_usuario'];
      $_SESSION['admin']['nombre']=$resultado['nombre'];
	...
	<body>
		...
		<section class="body-sign">
			<div class="center-sign">
					...
					<div class="card-body">
						<form role="form" method="post" data-toggle="validator">
							...
							<div class="form-group mb-3">
								...
								<div class="input-group">
									<input name="contrasena" id="contrasena" type="password" class="form-control form-control-lg" />
									<span class="input-group-append">
										<span class="input-group-text">
		                    ...
		                    ?> 
		                        ...
		                        <label class="bg-danger" style="color: #fff;"><?=$_SESSION['admin']['error'];?></label><BR>
				...
				<p class="text-center text-muted mt-3 mb-3">&copy; Grupo LAHE 2021. </p>
			</div>
		</section>
		<!-- end: page -->
