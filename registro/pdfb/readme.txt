The PDFB Library by Chirag Mehta ( http://chir.ag/tech/download/pdfb ) combines the following three PHP libraries and makes it very easy for even novice PHP programmers to generate high-quality dynamic PDF files with barcodes (UPC, C39, C128, I25):
...
For help and documentation on how to use the Barcode functions of PDFB, view the source-code of demo.php file. Feel free to contact Chirag Mehta at http://chir.ag/tech for further information.

As noted on http://chir.ag/tech/download/ - all the free downloads on http://chir.ag/tech/ site, including the PDFB Library by Chirag Mehta, are released under the Creative Commons License: http://creativecommons.org/licenses/by/2.5/
