...
$consulta="SELECT * FROM laboratorios WHERE id_laboratorio =".base64_decode($_GET['id_laboratorio']);
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif; text-align: justify;">
                                                                                    '.$registrado["nombrecompleto"].', usted ha quedado registrado al sistema de becas para médicos.
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                                                    ...
                                                                                    Datos de acceso para el sistema de becas
                                                                            ...
                                                                            <tr>
                                                                                <td style="color: #a4a4a4; line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                                                    ...
                                                                                    <strong>Usuario: </strong>'.$registrado['nombreusuario'].'<br>
                                                                                    <strong>Contraseña: </strong>'.$registrado["contrasena"].'<br>
                                                                                    <strong>Becas: </strong>'.$registrado["numbecados"].'<br>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td height="15"></td>
                                                                            </tr>
                                                                            <tr><td height="15">Para ingresar y poder visualizar los médicos becados ingrese en el siguiente link, con su usuario y contraseña proporcionados en este correo.<br><br></td></tr>

                                                                            <tr><td height="15" style="text-align:center;"><a href="https://congresoamh2021.mx/admin/becas" target="_blank">LINK AL SISTEMA DE BECAS</a></td></tr>
                                                                        </tbody>
                                                                    </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr bgcolor="7087A3">
                                            <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
                                                © Copyright 2021. Powered by <a href="http://www.grupolahe.com/">Grupo LAHE</a>
...
$mail->FromName = utf8_decode('AMH');           // Nombre del remitente
$mail->Subject = utf8_decode('Sistema de Becas XVI CONGRESO NACIONAL DE HEPATOLOGÍA 2021');                // Asunto

/** Incluir destinatarios. El nombre es opcional **/
$mail->addAddress($registrado['email'], $registrado['laboratorio']);
