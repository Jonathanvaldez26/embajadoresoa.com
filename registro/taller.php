...
<html class="fixed sidebar-left-collapsed">
  <head>
    ...
    <title>REGISTRADOS TALLER</title>
                  ...
                  <div class="card-body row">
                    ...
                    <div class="col-xl-12">
                      <table class="table table-bordered mb-0" id="datatable-tabletools">
                        ...
                        <tbody>
                          <?php
                          $sql_gafetes="SELECT * FROM registrados GROUP BY email";
                          ...
                          <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $gafete['nombre']." ".$gafete['apellidop']." ".$gafete['apellidom']; ?></td>
                            <td><?php echo $gafete['email']; ?></td>
                            <td><?php echo $gafete['telefono']; ?></td>
                            <td><?php echo $gafete['especialidad']; ?></td>
                            <td><?php echo $gafete['fecha_registro']; ?></td>
